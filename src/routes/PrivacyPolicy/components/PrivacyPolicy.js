  ...
  render() {
    return (
      <div className="container">
        ...
        <p>
          Kleener ("us", "we", or "our") operates the https://kleener-67e6a.firebaseapp.com website (the "Service").
        </p>

        <p>
          This page informs you of our policies regarding the collection, use, and disclosure of personal data when you
          use our Service and the choices you have associated with that data. Our Privacy Policy for Kleener is managed
          through <a href="https://www.freeprivacypolicy.com/free-privacy-policy-generator.php">Free Privacy Policy</a>.
        </p>
        ...
        <p>
          ...
          https://kleener-67e6a.firebaseapp.com
        </p>
        ...
        <p>Kleener uses the collected data for various purposes:</p>
        <ul>
        ...
        <p>
          Kleener will take all steps reasonably necessary to ensure that your data is treated securely and in
        ...
        <p>Kleener may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
        <ul>
          <li>To comply with a legal obligation</li>
          <li>To protect and defend the rights or property of Kleener</li>
        ...
        <ul>
          <li>By email: olhilton@gmail.com</li>
        </ul>
      </div>
    );
  }
